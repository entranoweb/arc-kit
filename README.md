...
**Claude Code** (premier experience) — install the ArcKit plugin (requires **v2.1.156+**):
...
**Latest Release**: [v5.11.2](https://github.com/tractorjuice/arc-kit/releases/tag/v5.11.2)
...
- **AI Coding Agent**: [Claude Code](https://www.anthropic.com/claude-code) v2.1.156+ (via plugin), [Gemini CLI](https://github.com/google-gemini/gemini-cli) (via extension), [OpenCode CLI](https://opencode.net/cli) (via CLI), or [OpenAI Codex CLI](https://chatgpt.com/features/codex) (via CLI)
...
- **Latest Version**: [v5.11.2](https://github.com/tractorjuice/arc-kit/releases/tag/v5.11.2)
